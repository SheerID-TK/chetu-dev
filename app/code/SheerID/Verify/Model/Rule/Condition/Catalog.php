<?php
//class SheerID_Verify_Model_Rule_Condition_category extends Mage_CatalogRule_Model_Rule_Condition_Combine {
class SheerID_Verify_Model_Rule_Condition_Catalog extends Mage_CatalogRule_Model_Rule_Condition_Address {
